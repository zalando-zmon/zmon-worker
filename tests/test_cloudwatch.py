...
def test_cloudwatch(monkeypatch):
    ...
    client.get_metric_statistics.return_value = {'Datapoints': [{'Average': 100.25}]}
    get = MagicMock()
    ...
    elb_data = cloudwatch.query({'AvailabilityZone': 'NOT_SET', 'LoadBalancerName': 'pierone-*'}, 'Latency', 'Average', namespace='ELB')
